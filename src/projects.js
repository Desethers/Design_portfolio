    ...
    caseStudy: {
      ...
      product: {
        ...
        screens: [
          {
            tag: "Positionnement",
            title: "D'un site web à une infrastructure",
            text: "Le projet visait initialement à aider les galeries à mieux présenter et partager leurs œuvres en ligne. L'analyse des usages a révélé un problème plus large : les informations circulent difficilement entre l'inventaire, la publication et les échanges avec les collectionneurs. Vitreen a donc évolué d'un outil de création de sites vers une infrastructure connectée aux pratiques existantes.",
          ...
          },
          {
            ...
            text: "Les échanges menés dans le secteur font ressortir deux constantes. Elles sont présentées ici comme des enseignements anonymisés ; les verbatims et captures pourront les remplacer sans modifier la structure.",
  ...
  },
  {
    ...
    caseStudy: {
      useCase: {
        ...
        intro:
          "Comment faire circuler les données d'œuvres dans les outils que les galeries utilisent déjà ?",
        body: [
        ...
        modules: [
          ...
          {
            tag: "Stack & workflow",
            title: "Du concept au prototype opérationnel",
            text: "La stack accompagne une boucle courte : cadrer l'architecture produit, prototyper les surfaces dans le navigateur, connecter les contenus et préparer les intégrations.\n\nChaque outil intervient à une étape précise plutôt que comme une couche technique isolée.",
            type: "vitreen-stack",
            items: [
              { name: "Figma", role: "Cadrage", icon: "/icones/figma-color.png" },
              { name: "Claude", role: "Architecture", icon: "/icones/claudecode-text.svg" },
        ...
        next: {
          title: "Étendre la couche de distribution",
          text: "Brancher progressivement chaque canal déjà utilisé par la galerie, jusqu'à piloter tout l'opérationnel — inventaire, sélections, inquiries, ventes — depuis un seul point de continuité.",
          cards: [
            { title: "Distribute en un clic", text: "Transformer une sélection en viewing room, PDF ou lien partageable directement depuis Gallery OS, sans recomposer le contenu." },
            { title: "Plus de canaux", text: "Étendre l'add-in à Outlook, brancher WhatsApp Business, Stripe et les calendriers — chaque canal devient un point d'entrée vers Gallery OS." },
            { title: "Companion mobile", text: "Valider une vente, envoyer une sélection ou répondre à une inquiry directement depuis le téléphone, en mobilité sur un stand ou en accrochage." },
            { title: "Valider le revenu", text: "Mesurer conversion et usage sur les galeries pilotes pour confirmer le modèle d'abonnement avant d'élargir." },
          ],
        },
      },
    },
