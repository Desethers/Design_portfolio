export const projects = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      product: {
        processAnnotation: "CMS → Digital Sales Partner → vocabulaire galerie → copy FR/EN",
        processCaption: "Le pivot de positionnement qui a redessiné la landing page de bout en bout — du vocabulaire de navigation jusqu'à la copy bilingue.",
        screens: [
          {
            tag: "Positionnement",
            title: "« Digital Sales Partner », pas CMS",
            text: "Le premier jet de la landing parlait le vocabulaire SaaS générique — « plateforme », « CMS », « responsive ». Le pivot vers « Digital Sales Partner » a tout changé : Vitreen ne remplace pas les outils d'une galerie, il les connecte. La hero copy — « Your gallery, wherever you already work » — et la structure de toute la page découlent de ce repositionnement.",
            media: "/vitreen/Frame 5.png",
          },
          {
            tag: "Navigation",
            title: "Mega-menu Products — vocabulaire galerie",
            text: "Plutôt que « Features » ou « Dashboard », le mega-menu liste Artworks Management, Public & Private Publishing, Collector Relationships, Gallery Assistants — des intitulés pensés pour des marchands d'art, pas pour des développeurs.",
            type: "vitreen-products",
          },
          {
            tag: "Copy",
            title: "Copy bilingue FR/EN",
            text: "Chaque écran orienté collectionneur — viewing room, sélection privée — a été rédigé en français et en anglais en parallèle, pas traduit après coup. Le ton reste consultatif côté galerie, plus direct côté collectionneur.",
